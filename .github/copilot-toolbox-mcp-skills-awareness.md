...
_Generated: 2026-09-02T08:11:52.310Z_
...
Workspace `mcp.json` _(folder: societal-challenge-board)_

- **c:\Users\utkar\OneDrive\Documents\societal-challenge-board\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\utkar\AppData\Roaming\Code\User\mcp.json** — _File missing_
